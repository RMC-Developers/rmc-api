...
module.exports = {
    DB_URL : process.env.DB_URI || `mongodb+srv://hello_db_user:kQdjQTAcN6FpUY8e@rmc-free-cluster.1ujtfpu.mongodb.net/RMCretryWrites=true&w=majority&appName=RMC-Free-Cluster`,
